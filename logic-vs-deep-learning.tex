...
\begin{eqnarray}
\boxed{\mbox{输出命题 $Q_i$ 由原子 $b_i$ 组成}} \quad Q &=& [b_1 ... b_K] \\
\boxed{\mbox{输入命题 $P_i$ 由原子 $a_i$ 组成}} \quad P_i &=& [a_1...a_K] \\
\boxed{\mbox{Self-Attention}} \quad Q &=& \alpha(P_i \;; P_1 ... \hat{P_i} ... P_N)
\end{eqnarray}
$P_1 ... \hat{P_i} ... P_N$ 的意思是 $P_1 ... P_N$ 除了 $P_i$. \\
$\alpha(P_i \;; ... )$ 是图 (\ref{fig:self-attention}) 的函数结构，也可以理解为 以 $P_i$ 为 query 的 self Attention.
