...
In equation (\ref{eqn:circuit1}), it is helpful to know the rows and columns of the input, and that the tensor product takes care of them separately.  For example $\mathrm{Id} \otimes W$ means that ....
